...
void test_vector_clear()
{
	...
	}
	{
		...
		{
			cout << "inner vector #" << i << ", size : " << it->size() << " capacity : " << it->capacity()
				<< endl;
			i++;
		}
		...
		{
			it->clear();
			cout << "After clear inner vector #" << i << ", size : " << it->size()
				<< " capacity : " << it->capacity() << endl;
			i++;
		}
	...
	}
	{
		...
		cout << "After clear(), size : " << my_vec.size() << " capacity : " << my_vec.capacity() << endl;
		my_vec.clear();
		cout << "After second clear(), size : " << my_vec.size() << " capacity : " << my_vec.capacity()
			<< endl;
	}
	{
